...
<script type="text/javascript">
	function delcheck() {
		...
		if(result == true){
			document.form1.action.value="timeDelete";
...
<jsp:useBean id="hp" scope="request" class="jspbook.healthPlatform.Time" />
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarButtonsExample">
          ...
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            <li class="nav-item">
              <a class="nav-link" href="healthPlatform_control.jsp?action=timeList">헬스장</a>
            </li>
          </ul>
...
[<a href=healthPlatform_control.jsp?action=timeList>운동시간 목록으로</a>] <p>
<form name=form1 method=post action=healthPlatform_control.jsp>
<input type=hidden name="time_id" value="<%=hp.getTime_id()%>">
<input type=hidden name="action" value="timeUpdate">

<table border="1">
  <tr>
    <th>시작시간</th>
    <td><input type="text" name="time_name" value="<%=hp.getTime_start() %>"></td>
  </tr>
  <tr>
    <th>운동시간</th>
    <td><input type="text" name="time_address" value="<%=hp.getTime_duration() %>"></td>
  </tr>
    <tr>
    <th>유저번호</th>
