...
<input type=hidden name="action" value="timeInsert">

<table border="1">
  <tr>
    <th>시작시간</th>	
    <td><input type="text" name="time_start" maxlength="30"></td>
  </tr>
  <tr>
    <th>운동시간</th>
    <td><input type="text" name="time_duration"></td>
  </tr>  
  <tr>
    <th>유저번호</th>
    <td><input type="number" name="user_id"><%session.getAttribute("id"); %></td>
  </tr>
  <tr>
